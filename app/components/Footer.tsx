...
export default function Footer() {
  return (
    <div className="mt-14 mx-6 md:mx-20 p-4 md:p-8 border-t border-neutral-500 text-neutral-500 flex flex-col space-y-2 md:flex-row md:space-y-0 md:items-center md:justify-between text-xs">
