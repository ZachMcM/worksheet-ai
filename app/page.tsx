    ...
    <main className="w-screen h-screen bg-neutral-950 flex flex-col justify-between">
      ...
      <div className="w-full flex justify-center p-6 text-center">
        <div className="w-full flex items-center flex-col space-y-6">
          <h1 className="text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-pink-500">Crush your next speech</h1>
          <p className="md:text-xl max-w-3xl text-center">Prepare for your next speech, presentation, or just improve your speaking in general with AI assisted speech coaching!</p>
